    ...
    <div className="bg-white border border-[#E5E5E5] p-8 shadow-hairline rounded-sm">
      ...
      {customCheckoutEnabled ? (
        <button
          ...
          className="cta-breathe cta-smoke block w-full text-white text-center text-[10px] font-semibold tracking-[0.16em] uppercase py-3.5 disabled:opacity-60"
        >
        ...
        <a
          className="bokunButton cta-breathe cta-smoke block w-full text-white text-center text-[10px] font-semibold tracking-[0.16em] uppercase py-3.5 aria-[disabled=true]:opacity-60"
        ...
        <a
          className="cta-breathe cta-smoke block w-full text-white text-center text-[10px] font-semibold tracking-[0.16em] uppercase py-3.5"
          href={mailtoFallback}
        >
          {t('requestByEmail')}
        </a>
