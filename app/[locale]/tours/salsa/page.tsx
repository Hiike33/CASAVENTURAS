...
const COPY = {
  en: {
    ...
    afterBooking: 'After booking, go directly to 1050 Calle Marianna, 00907 San Juan, Casa Santurce Rooftop. Zoe will be waiting at 6 PM.',
    fullDayEyebrow: 'Make it a full day',
    fullDayBody: 'Combine with an El Yunque morning tour, back by 3 PM, salsa at 6 PM. Cavi can plan the whole day.',
  ...
  es: {
    ...
    afterBooking: 'Después de reservar, ve directo a 1050 Calle Marianna, 00907 San Juan, Casa Santurce Rooftop. Zoe te espera a las 6 PM.',
    fullDayEyebrow: 'Haz un día completo',
    fullDayBody: 'Combínalo con un tour de El Yunque en la mañana: de vuelta a las 3 PM, salsa a las 6 PM. Cavi te arma el plan completo.',
  ...
  fr: {
    ...
    afterBooking: "Après la réservation, va directement au 1050 Calle Marianna, 00907 San Juan, Casa Santurce Rooftop. Zoe t'attend à 18h.",
    fullDayEyebrow: "Fais-en une journée complète",
    fullDayBody: "Combine avec un tour d'El Yunque le matin : retour à 15h, salsa à 18h. Cavi te monte la journée complète.",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: locale === routing.defaultLocale ? `${siteConfig.url}/tours/salsa` : `${siteConfig.url}/${locale}/tours/salsa` },
    openGraph: {
      title: tour.name,
      description: tour.description,
